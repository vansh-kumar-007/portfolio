  ...
  return (
    <>
      <button
        ...
        className="fixed bottom-6 left-6 z-40 hidden items-center gap-2 rounded-full border border-white/10 bg-background/80 px-4 py-2 text-sm text-muted-foreground backdrop-blur-sm transition-colors hover:border-emerald-500/30 hover:text-foreground md:flex"
      >
              ...
              <Command.List className="max-h-80 overflow-y-auto p-2">
                ...
                <Command.Group heading="Navigation" className="px-2 py-1.5 text-xs text-muted-foreground">
                  <Command.Item
                    ...
                    className="flex cursor-pointer items-center gap-3 rounded-lg px-3 py-2 text-sm aria-selected:bg-emerald-500/20"
                  >
